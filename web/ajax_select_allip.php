...
if ( $s_u_level == 1)
{
	$ip_sql = "select ip from ipinfo where IP != '0.0.0.0'  and GroupId = ".$group;
}
else
{
	$ip_sql = "select ip from ipinfo where  IP != '0.0.0.0'  and ipinfo.GroupId=".$group;
}
...
<table border="0">
  <tr>
    <td valign="top">所属组：
      <select name="group" class="anniu" id="group" width="50" onChange="showHint_get_allip(this.value,ip.value)">
