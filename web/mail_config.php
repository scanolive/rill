...
<title><?php echo $TITLE_NAME."-";?>报警邮件设置</title></head>
   ...
   <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
     <tr>
       <td valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="td_clo_blue">
           <tr>
             <td height="33" background="image/tab_bg1.gif">&nbsp;&nbsp;&nbsp;&nbsp;<span class="title1"> 报警邮件设置</span></td>
           </tr>
           <tr>
             <td height="8"></td>
           </tr>
           ...
           <tr>
             <td><form action="" method="post" >
               <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="td_clo_blue">
                 <tr>
